...
<body>
	...
	<br>
		<br>
	<h2>Keisti VIDEO pristatymą: </h2><br>
...
if (isset($_POST['text']))
{
	echo " <b> Pakeitimas Išsaugotas ! </b> ";
...
<textarea name="text" cols="40" rows="1"><?php echo htmlspecialchars($text);?></textarea><br>
	<input type="submit" name="Redaguoti" value="Keisti video įrašą" >
