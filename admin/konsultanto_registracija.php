...
<div class="form">
      <label for="kur">Vardas: </label><input type="text" id="kur" class="kur">
	  <label for="kiek">Slaptažodis: </label><input type="text" id="kiek" class="kiek">
...
function ieskok() {
	...
	let url = "http://localhost/it/admin/reg_api.php";
  ...
  .then(data => {
	...
	document.getElementById("jsonats").innerHTML="Registracija atlikta, Registruotas Konsultantas --> id: " + data[data.length - 1].id + "  Vardas : " + data[data.length - 1].usr;    // parodom gautą atsakymą JSON formatu
