...
<body>
	...
	<br>
		<br>
	<h2>Pašalinti konsultantą </h2><br>
	 Norint pašalinti konsultantą iš sąrašo įveskite jo ID <b></b><b></b> <br><br>
<div class="form">
...
<script>
const lspausk = document.querySelector('.spausk'); 
const lkur = document.querySelector('.kur');  	
lkur.value='';					  // kas juose įrašyta
lkur.focus(); 
lspausk.addEventListener('click', ieskok);
...
function ieskok() {
	...
	let kur = lkur.value;
	let url = "http://localhost/it/admin/del_api.php";
	let ats,string_ats,x,txt;
	url+="/?kur="+kur;                      			// prijungiam GET užklausai parametrus ?kur=abc&kiek=123
	document.getElementById("uzklausa").innerHTML="<br>";		// parodom kokia užklausa siunčiama
  ...
  .then(data => {
    string_ats=JSON.stringify(data);							// objektą data paverciam JSON tekstu
	document.getElementById("jsonats").innerHTML="Šalinimas atliktas, Pašalintas konsultantas --> id: " + kur;    // parodom gautą atsakymą JSON formatu
    console.log(data);										 //derinimui
